...
const proposed: Mission[] = [
  {
    ...
    studentsCount: 1, contact: 'Fanny - The Good Workers',
  ...
  },
  {
    ...
    studentsCount: 2, contact: 'Carla - The Good Workers',
  ...
  },
  {
    ...
    studentsCount: 6, contact: 'Shanaelle - The Good Workers',
  ...
  },
  {
    ...
    studentsCount: 10, contact: 'Fanny - The Good Workers',
  ...
  },
  {
    ...
    studentsCount: 3, contact: 'Carla - The Good Workers',
  ...
  },
  {
    ...
    studentsCount: 2, contact: 'Shanaelle - The Good Workers',
  ...
  },
  {
    ...
    studentsCount: 4, contact: 'Fanny - The Good Workers',
...
const recentDone: Mission[] = [
  ...
  },
  {
    ...
    studentsCount: 1, contact: 'Shanaelle - The Good Workers',
...
function buildHistory(): Mission[] {
  ...
  for (let i = 0; i < 30; i++) {
    ...
    missions.push({
      ...
      city: historyCities[k], address: `${historyCities[k]}`, studentsCount: 1 + (k % 3), contact: 'Carla - The Good Workers',
  ...
  for (let i = 0; i < 5; i++) {
    ...
    missions.push({
      ...
      studentsCount: 2, contact: 'Fanny - The Good Workers', description: 'Mission annulée par le client.', dressCode: '',
...
const messages: Message[] = [
  { id: 'm1', missionId: 'd1', from: 'staff', author: 'Carla - The Good Workers', at: '2026-09-08T18:30:00', text: 'Hello Julien ! Tu es bien confirmé sur la mission Snipes de demain. RDV à 8h50 devant l\'entrée du magasin, demande Mehdi le responsable. Tenue streetwear noire 🙂' },
  { id: 'm2', missionId: 'd1', from: 'student', author: 'Julien', at: '2026-09-08T18:42:00', text: 'Parfait, merci Carla ! À demain.' },
  { id: 'm3', missionId: 'd1', from: 'staff', author: 'Carla - The Good Workers', at: '2026-09-09T17:05:00', text: 'Votre mission est maintenant terminée ! Pensez bien à valider l\'étape "c\'est terminé" dans l\'application. Merci pour ton implication 🙌' },
  { id: 'm4', missionId: 'd2', from: 'staff', author: 'Fanny - The Good Workers', at: '2026-09-07T16:10:00', text: 'Bonjour Julien, petit rappel pour la mission Testwe demain à 10h. Présente-toi à l\'accueil du 10 rue de Penthièvre avec une pièce d\'identité.' },
  { id: 'm5', missionId: 'd2', from: 'staff', author: 'Fanny - The Good Workers', at: '2026-09-08T12:02:00', text: 'Votre mission est maintenant terminée ! Pensez bien à valider l\'étape "c\'est terminé" dans l\'application. Belle journée ☀️' },
  { id: 'm6', missionId: 'd3', from: 'staff', author: 'Shanaelle - The Good Workers', at: '2026-09-03T11:20:00', text: 'Hello ! Pour la mission Eureka Fripe vendredi, RDV 13h50 en boutique. Le brief se fait sur place avec Léa.' },
  { id: 'm7', missionId: 'd3', from: 'student', author: 'Julien', at: '2026-09-03T11:35:00', text: 'Top, merci !' },
  { id: 'm8', missionId: 'd3', from: 'staff', author: 'Shanaelle - The Good Workers', at: '2026-09-04T19:50:00', text: 'Votre mission est maintenant terminée ! Pensez bien à valider l\'étape "c\'est terminé" dans l\'application 🙏' },
];
