  ...
  switch (step) {
    ...
    case 'identity':
      ...
      if (digits(f.phone).length !== 10) return 'Le numéro de téléphone doit avoir 10 chiffres.';
      {
        ...
        if (ageOf(iso) < 18) return 'Il faut avoir 18 ans pour rejoindre StudentPop.';
      }
      return null;
    case 'studies':
      ...
      <div className="flex h-full flex-col bg-teal px-6 pb-[max(env(safe-area-inset-bottom),24px)] pt-[max(env(safe-area-inset-top),24px)] text-center text-white">
        <div className="flex flex-1 flex-col items-center justify-center">
          ...
          <p className="mt-4 text-lg text-white/90">
            Ton compte est créé. L'équipe StudentPop valide ton profil sous 48 h — en attendant, découvre déjà les propositions autour de toi.
          </p>
        </div>
        ...
        <div className="flex-1 overflow-y-auto px-5 pb-6 pt-5">
          <AnimatePresence mode="wait" initial={false}>
            ...
            >
              {step === 'account' && (
                <>
                  <StepTitle title="Crée ton compte" subtitle="Tes identifiants pour te connecter à StudentPop." />
              ...
              {step === 'identity' && (
                <>
                  ...
                  <div className="space-y-4">
                    ...
                    <Field label="Date de naissance" hint="Il faut avoir 18 ans pour travailler avec StudentPop.">
                      <input
                        inputMode="numeric"
                        autoComplete="bday"
              ...
              {step === 'status' && (
                <>
                  <StepTitle title="Ton statut auto-entrepreneur" subtitle="Pour être payé, StudentPop travaille avec des étudiants auto-entrepreneurs." />
